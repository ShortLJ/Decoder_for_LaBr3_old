...
void datareadingOnline_final(){
	char filename[90]="Na22_att_run04";

//tree

	TFile *treefile = new TFile(Form("%s_final.root",filename),"recreate");
	...
	UInt_t BoardID;
	UInt_t Group;
	UInt_t channelsssssssssss = 2;	// 1=0b01 for ch0, 2=0b10 for ch1, 3=0b11 for ch0,1 Coin
...
//	tree->Branch("waveform", waveform,"waveform[channels][waveform_length]/F");
	...
	tree->Branch("waveform_ch1", waveform_ch1,"waveform_ch0[waveform_length]/F");
...
//	cout<<"Filesize = "<<Filesize<<endl;
	...
	int ient=0;
//	for (pqrc_flag[0]=0; ient<500000000; ){
